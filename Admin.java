...
//        Restaurant[] newRest = new Restaurant[resturant.length];
//        for (i:
//             resturant) {
...
//    }
//
//    public Restaurant setNewResturant()     //this method is a parameter for addResturantToResturants();
//    {
...
//        System.out.println("Enter resturant name ");             //
//
//        Restaurant resturant = new Restaurant(name, phoneNumber, category, etc);
//        return resturant;
//    }
//
//    public Restaurant addResturantToResturants(Restaurant[] allResturants, Restaurant newResturant, String, String) {
//
//        for (i:
//             allResturants) {
...
//
//
//    public Item addItemToMenu(Restaurant resturant, int resturantId, String itemName, int itemPrice) {
//        for (i:
//             resturant) {
...
//
//
//    public String DisplayMostRatedResturant(Restaurant[]) {
//        int maxRate = 0;
